...
Please see https://github.com/masamitsu-murase/deform_conv2d_onnx_exporter/pull/2
"""
...
def get_tensor_dim_size(tensor, dim):
    ...
    if tensor_dim_size == None:
        ...
        if dim == 0:
            ...
            tensor_dim_size = x_strides[0] // x_strides[1]
        elif dim == 2:
            tensor_dim_size = x_strides[1] // x_strides[2]
        elif dim == 3:
            tensor_dim_size = x_strides[2]
